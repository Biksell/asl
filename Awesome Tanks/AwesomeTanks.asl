state("flashplayer_32_sa") {
    ...
    bool complete: 0xD18438, 0x150, 0x504, 0xE8, 0x0, 0x38; // second one of two values found in the scan
}
...
split {
    return settings["split"] && (!old.complete && current.complete && vars.completedLevels.Add(old.level));
}
